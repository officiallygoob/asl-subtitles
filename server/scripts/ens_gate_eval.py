...
def main() -> int:
    ...
    ap.add_argument("--ship-val-a", type=float, default=0.5207100510597229)
    ap.add_argument("--ship-val-b", type=float, default=0.47337278723716736)
    ap.add_argument("--ship-test", type=float, default=0.4651162922382355)
