...
def main() -> int:
    ...
    ap.add_argument("--ship-val-a", type=float, default=0.45544554455445546)
    ap.add_argument("--ship-val-b", type=float, default=0.39705882352941174)
    ap.add_argument("--ship-test", type=float, default=0.45348837209302323)
