...
def main() -> int:
    ...
    ap.add_argument("--ship-val-a", type=float, default=0.5325443744659424)
    ap.add_argument("--ship-val-b", type=float, default=0.4911242723464966)
    ap.add_argument("--ship-test", type=float, default=0.4844961240310077)
