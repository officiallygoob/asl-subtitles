...
def main() -> int:
    ...
    ap.add_argument("--ship-val-a", type=float, default=0.5502958297729492)
    ap.add_argument("--ship-val-b", type=float, default=0.48520711064338684)
    ap.add_argument("--ship-test", type=float, default=0.4806201457977295)
