...
def _motion_spec(gloss: str):
    ...
    table = {
        ...
        # Expanded conversational set
        "WELCOME": ("open", path_out, "both", {"y0": 0.45}),
        "NICE": ("flat", path_circle, "right", {"y0": 0.48}),
        "MEET": ("point", path_out, "both", {"y0": 0.48}),
        "MOTHER": ("open", path_toward_chin, "right", {"y0": 0.28}),
        "FATHER": ("open", path_toward_chin, "right", {"y0": 0.26}),
        "SISTER": ("point", path_lateral, "right", {"y0": 0.35}),
        "BROTHER": ("fist", path_lateral, "right", {"y0": 0.35}),
        "BABY": ("flat", path_wave, "both", {"y0": 0.50}),
        "PERSON": ("flat", path_down, "both", {"y0": 0.40}),
        "DEAF": ("point", path_lateral, "right", {"y0": 0.28}),
        "HEARING": ("point", path_circle, "right", {"y0": 0.28}),
        "RIGHT": ("point", path_up, "right", {"y0": 0.40}),
        "WRONG": ("point", path_toward_chin, "right", {"y0": 0.30}),
        "BIG": ("open", path_out, "both", {"y0": 0.45, "amp": 1.4}),
        "SMALL": ("pinch", path_still, "right", {"y0": 0.45}),
        "NEW": ("flat", path_out, "right", {"y0": 0.48}),
        "OLD": ("fist", path_down, "right", {"y0": 0.28}),
        "GIVE": ("flat", path_out, "right", {"y0": 0.45}),
        "TAKE": ("claw", path_toward_chin, "right", {"y0": 0.45}),
        "HAVE": ("flat", path_toward_chin, "both", {"y0": 0.45}),
        "MAKE": ("fist", path_twist := path_circle, "both", {"y0": 0.48}),
        "THINK": ("point", path_toward_chin, "right", {"y0": 0.24}),
        "FEEL": ("open", path_up, "right", {"y0": 0.45}),
        "REMEMBER": ("fist", path_toward_chin, "right", {"y0": 0.26}),
        "FORGET": ("open", path_out, "right", {"y0": 0.28}),
        "TELL": ("point", path_out, "right", {"y0": 0.30}),
        "ASK": ("point", path_up, "right", {"y0": 0.42}),
        "CALL": ("c", path_toward_chin, "right", {"y0": 0.32}),
        "LEAVE": ("flat", path_out, "right", {"y0": 0.45}),
        "STAY": ("flat", path_still, "right", {"y0": 0.48}),
        "PLAY": ("hook", path_wave, "both", {"y0": 0.48}),
        "READ": ("flat", path_down, "right", {"y0": 0.40}),
        "SIGN": ("claw", path_circle, "both", {"y0": 0.45}),
        "FOOD": ("pinch", path_toward_chin, "right", {"y0": 0.32}),
        "WATER": ("point", path_toward_chin, "right", {"y0": 0.32}),
        "COFFEE": ("fist", path_circle, "right", {"y0": 0.48}),
        "THIRSTY": ("point", path_down, "right", {"y0": 0.32}),
        "STORE": ("flat", path_out, "both", {"y0": 0.45}),
        "HOSPITAL": ("point", path_cross := path_lateral, "right", {"y0": 0.35}),
        "BATHROOM": ("fist", path_wave, "right", {"y0": 0.45}),
        "OUTSIDE": ("flat", path_out, "right", {"y0": 0.42}),
        "INSIDE": ("flat", path_toward_chin, "right", {"y0": 0.42}),
        "HERE": ("flat", path_still, "right", {"y0": 0.55}),
        "THERE": ("point", path_out, "right", {"y0": 0.42}),
        "CITY": ("flat", path_up, "both", {"y0": 0.40}),
        "YESTERDAY": ("fist", path_out, "right", {"y0": 0.28}),
        "NOW": ("flat", path_down, "both", {"y0": 0.48}),
        "MORNING": ("flat", path_up, "right", {"y0": 0.50}),
        "NIGHT": ("flat", path_down, "right", {"y0": 0.30}),
        "WEEK": ("point", path_lateral, "right", {"y0": 0.45}),
        "MONTH": ("point", path_down, "right", {"y0": 0.40}),
        "YEAR": ("fist", path_circle, "both", {"y0": 0.45}),
        "ANGRY": ("claw", path_up, "right", {"y0": 0.30}),
        "SCARED": ("open", path_toward_chin, "both", {"y0": 0.45}),
        "SICK": ("point", path_toward_chin, "right", {"y0": 0.32}),
        "HURT": ("point", path_nod, "both", {"y0": 0.45}),
        "ONE": ("point", path_still, "right", {"y0": 0.42}),
        "TWO": ("point", path_still, "right", {"y0": 0.42, "amp": 0.3}),
        "THREE": ("open", path_still, "right", {"y0": 0.42}),
        "FOUR": ("open", path_still, "right", {"y0": 0.42, "amp": 0.2}),
        "FIVE": ("open", path_still, "right", {"y0": 0.42}),
        "SIX": ("ok", path_still, "right", {"y0": 0.42}),
        "SEVEN": ("ok", path_still, "right", {"y0": 0.40}),
        "EIGHT": ("ok", path_still, "right", {"y0": 0.38}),
        "NINE": ("ok", path_still, "right", {"y0": 0.36}),
        "TEN": ("fist", path_wave, "right", {"y0": 0.42}),
        "PHONE": ("c", path_toward_chin, "right", {"y0": 0.32}),
        "TEXT": ("pinch", path_lateral, "both", {"y0": 0.48}),
        "EMAIL": ("point", path_out, "right", {"y0": 0.40}),
        "MONEY": ("flat", path_out, "right", {"y0": 0.48}),
        "BUY": ("flat", path_out, "right", {"y0": 0.50}),
        "BUSY": ("claw", path_circle, "both", {"y0": 0.45}),
        "READY": ("flat", path_down, "both", {"y0": 0.48}),
        "IMPORTANT": ("claw", path_up, "right", {"y0": 0.40}),
        "PROBLEM": ("fist", path_nod, "both", {"y0": 0.45}),
        "QUESTION": ("point", path_circle, "right", {"y0": 0.35}),
        "ANSWER": ("point", path_out, "right", {"y0": 0.35}),
        "IDEA": ("point", path_up, "right", {"y0": 0.24}),
        "CAR": ("fist", path_lateral, "both", {"y0": 0.48}),
        "BUS": ("fist", path_out, "both", {"y0": 0.48}),
        "WALK": ("point", path_nod, "both", {"y0": 0.55}),
        "SLEEP": ("flat", path_toward_chin, "right", {"y0": 0.28}),
        "BOOK": ("flat", path_out, "both", {"y0": 0.45}),
        "RED": ("point", path_toward_chin, "right", {"y0": 0.30}),
        "BLUE": ("claw", path_wave, "right", {"y0": 0.40}),
        "GREEN": ("claw", path_wave, "right", {"y0": 0.42}),
        "BLACK": ("point", path_lateral, "right", {"y0": 0.26}),
        "WHITE": ("flat", path_out, "right", {"y0": 0.30}),
        "RAIN": ("claw", path_down, "both", {"y0": 0.35}),
        "SUN": ("point", path_circle, "right", {"y0": 0.24}),
        "WEATHER": ("open", path_circle, "both", {"y0": 0.35}),
        "MONDAY": ("point", path_circle, "right", {"y0": 0.42}),
        "TUESDAY": ("point", path_circle, "right", {"y0": 0.43}),
        "WEDNESDAY": ("point", path_circle, "right", {"y0": 0.44}),
        "THURSDAY": ("point", path_circle, "right", {"y0": 0.45}),
        "FRIDAY": ("point", path_circle, "right", {"y0": 0.46}),
        "SATURDAY": ("point", path_circle, "right", {"y0": 0.47}),
        "SUNDAY": ("open", path_circle, "both", {"y0": 0.40}),
        "ENGLISH": ("claw", path_circle, "right", {"y0": 0.40}),
        "ASL": ("claw", path_wave, "both", {"y0": 0.42}),
    }
